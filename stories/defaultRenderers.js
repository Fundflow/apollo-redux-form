...
const renderers = {
  Date: {
    render: (props) => {
      const { input, label, meta: {  error, warning }, ...rest } = props;
  ...
  DateTime: {
    render: (props) => {
      const { input, label, meta: {  error }, ...rest } = props;
      return (
        <Form.Item
  ...
  Float: (props) => {
    ...
    return (
      <Form.Item
        ...
        label={label}
      >
          <InputNumber {...input} placeholder={label} {...rest} step={0.01} defaultValue={0} />
      </Form.Item>
    );
  },
  Int: (props) => {
    ...
    return (
      <Form.Item
        ...
        label={label}
      >
          <InputNumber {...input} placeholder={label} {...rest} defaultValue={0} />
      </Form.Item>
    );
  },
  Boolean: (props) => {
