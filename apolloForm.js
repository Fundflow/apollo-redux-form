...
function visitWithContext(context) {
                ...
                if (type) {
                    switch (type.kind) {
                        case 'InputObjectTypeDefinition':
                            var children = graphql_1.visit(type.fields, visitWithContext(context));
...
function buildForm(document, options) {
    ...
    var withForm = redux_form_1.reduxForm(__assign({ form: name, validate: validation_1.default.bind(undefined, fields) }, rest));
